def awaryjne_podlaczenie(**kwargs):
    html = f"""<p>Witam,</p>
  <span>{kwargs['wstep']}
  </span>
  ...
  <span><b>Notatka:</b> {kwargs['notatka']}</span>
  <span>Prosimy o realizację zlecenia w dniu dzisiejszym, potwierdzenie realizacji lub wskazanie przyczyn uniemożliwiających podłączenie klienta do sieci. W razie wątpliwości proszę o kontakt telefoniczny.</span>
